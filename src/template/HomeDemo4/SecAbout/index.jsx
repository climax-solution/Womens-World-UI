      ...
      <div className="container">
        <div className="row align-items-center">
          <div className="col-12 col-lg-6 offset-lg-0">
            <div className="who-we-contant mt-s">
              <div className="dream-dots text-left" data-aos="fade-up" data-aos-delay="300">
                <span className="gradient-text text-light">Decentralized Trading Platform</span>
              </div>
          ...
          <div className="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
            <div className="welcome-meter floating-anim" data-aos="fade-up" data-aos-delay="200">
              <img src={img} alt="" />
            </div>
          </div>
        </div>
